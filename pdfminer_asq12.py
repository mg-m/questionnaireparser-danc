...
input_dir=r'C:\Users\mgautier\Desktop\DEVMOBETA\questionnaires\visit_3\asq'
data_list={}
...
print(df)
df.to_csv('asq_3.csv',index=False)
...
df.to_csv('asq_3_result.csv',index=False)
